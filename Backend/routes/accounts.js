...
router.get("/get", fetchUser, async (req, res) => {
  try {
    let accounts = await Account.find({ user: req.user }); //getting the user Id that we set in the fetchUser Middleware
...
//continue from here update and delete and getALL
